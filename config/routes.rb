Rails.application.routes.draw do
  ...
  get "spots/station" => "spots#station"
  ...
  get "seeks/scene" => "seeks#scene"
  get "seeks/terms" => "seeks#terms"
  ...
  get "course/:id/point/choice" => "points#choice"
  get "course/:id/point/add" => "points#add"
  ...
  get "searches/honme" => "searches#home"
