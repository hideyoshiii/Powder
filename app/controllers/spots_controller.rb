class SpotsController < ApplicationController
  ...
  def create
    ...
    @spot = current_user.spots.build(spot_params)
      ...
      if @spot.save
        @picture = Picture.new(image: params[:spot][:image], spot_id: @spot.id, user_id: current_user.id, course_id: 0)
        @picture.save
